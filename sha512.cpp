...
#define POLARSSL_CONFIG_FILE "sha512_config.h"
 ...
 */
void sha512(const char *input, size_t ilen,
             unsigned char output[64])
{
    ...
    sha512_init( &ctx );
    sha512_starts( &ctx, 0 );
    sha512_update( &ctx, (unsigned char*)input, ilen );
...
void sha512str(const char *in, size_t ilen, std::string& out)
{
